...
const menuItems = [
  { icon: LayoutDashboard, label: 'Dashboard', href: '/bank' },
  { icon: BarChart, label: 'Analytics', href: '/bank/analytics' },
  { icon: Users, label: 'users', href: '/bank/users' },
  { icon: Map, label: 'Land Records', href: '/bank/land-records' },
  { icon: Home, label: 'Loan Applications', href: '/bank/loans' },
  { icon: FileText, label: 'Survey Reports', href: '/bank/survey-reports' },
  { icon: DollarSign, label: 'Payments', href: '/bank/payments' },
  { icon: Bell, label: 'land transfer', href: '/bank/land-transfer' },
  { icon: Users, label: 'users', href: '/bank/loan-application' },
...
export const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="p-4">
        <Link href="/bank" className="flex items-center space-x-2">
